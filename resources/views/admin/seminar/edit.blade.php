...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="validate" action="/seminar/{{$seminar->id}}" class="form-horizontal comm_form" method="POST" role="form" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row fil_ters">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="title" placeholder="title" name="title"
                                autocomplete="off" value="{{ $seminar->title }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="subtitle" placeholder="Sub Title"
                                name="sub_title" autocomplete="off" value="{{ $seminar->title }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="subtitle" placeholder="Background Gradient"
                                name="background_gradient" autocomplete="off" value="{{ $seminar->background_gradient }}">

                        </div>
                    </div>
                    <?php 
                    $startDate=$seminar->start_time;
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control " name="description" id="description" autocomplete="off">{{ $seminar->description }}</textarea>

                        </div>
                    </div>
                </div>
                @if (!empty($seminar->addOns))
                    @foreach ($seminar->addOns as $val)
                        <div class="row fil_ters ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> Seminar Addon<code>*</code></label>
                                    <input type="text" class="form-control " id="addon" placeholder=" Seminar Addon"
                ...
                @if (!empty($seminar->tutor))
                    @foreach ($seminar->tutor as $val)
                        <div class="row fil_ters ">
                            <div class="col-md-6">
                                <div class="form-group">
                ...
                <div class="row fil_ters ">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="end_time" placeholder="testimonial"
                                name="testimonial[]" autocomplete="off" value="{{@$seminar->testimonial[0]->testimonial}}">
                  ...
                  {{--   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control " required id="order" placeholder="Order" value="{{ $seminar->order }}" name="order" >
