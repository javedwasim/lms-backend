...
<div class="card">
  ...
  <div class="card-body">
    <form id="validate" action="/seminar" class="form-horizontal comm_form" method="POST" role="form" enctype="multipart/form-data">
      @csrf
      <div class="row fil_ters">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="datetime-local" class="form-control "  id="start_time" placeholder="Sub Title" name="start_time" autocomplete="off">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="datetime-local" class="form-control "   id="end_time" placeholder="Sub Title" name="end_time" autocomplete="off">
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control " required name="description" id="description" autocomplete="off"></textarea>
      ...
      <div class="row fil_ters ">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control "  id="addon" placeholder=" Seminar Addon" name="addon[]" autocomplete="off">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="number" class="form-control " required id="order" placeholder="Enter Order" name="order" >
