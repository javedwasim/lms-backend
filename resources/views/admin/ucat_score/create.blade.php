...
<div class="card">
    ...
    <div class="card-body">
        <form id="validate" action="/ucatscore" class="form-horizontal comm_form" method="POST" role="form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 band" style="display: none" >
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " required id="min_score" placeholder="Min Score (%)" name="min_score" autocomplete="off" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " required id="max_score" placeholder="Max Score (%)" name="max_score" autocomplete="off" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " required id="score" placeholder="UCAT Score " name="score" autocomplete="off" required>
