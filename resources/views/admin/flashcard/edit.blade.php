...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="validate" action="/flashcard/{{$flashcard->id}}" class="form-horizontal comm_form" method="POST" role="form" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="row fil_ters">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="title" placeholder="title" name="title"
                                autocomplete="off" value="{{ $flashcard->title }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="subtitle" placeholder="Sub Title"
                                name="sub_title" autocomplete="off" value="{{ $flashcard->title }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="subtitle" placeholder="Background Gradient"
                                name="background_gradient" autocomplete="off" value="{{ $flashcard->background_gradient }}">

                        </div>
                    </div>
                    <?php 
                    $startDate=$flashcard->start_time;
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control " name="description" id="description" autocomplete="off">{{ $flashcard->description }}</textarea>

                        </div>
                    </div>
                </div>
                @if (!empty($flashcard->addOns))
                    @foreach ($flashcard->addOns as $val)
                        <div class="row fil_ters ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> FlashCard Addon<code>*</code></label>
                                    <input type="text" class="form-control " id="addon" placeholder=" FlashCard Addon"
                ...
                @if (!empty($flashcard->tutor))
                    @foreach ($flashcard->tutor as $val)
                        <div class="row fil_ters ">
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="end_time" placeholder="testimonial"
                                name="testimonial[]" autocomplete="off" value="{{@$flashcard->testimonial[0]->testimonial}}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control " id="position" placeholder="Enter Order" name="position" value="{{ $flashcard->position }}">
                ...
                <div class="row">
                    <div class="text-right col-xs-12 col-sm-12 col-md-12">
                      <input type="hidden" value="{{@$flashcard->id}}" name="id">
