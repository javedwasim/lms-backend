            ...
            <div class="row fil_ters">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control "  id="title" placeholder="name" name="name" autocomplete="off" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control "  id="subtitle" placeholder="Instruction" name="image" autocomplete="off" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control "  id="sort" placeholder="Order" name="sort" autocomplete="off" required>
