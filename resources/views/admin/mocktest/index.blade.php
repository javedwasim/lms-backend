...
<div class="card">
  <div class="card-header pb-0">
    <h5>Mocktest  
        <a href="{{url('mocktest/add')}}" class="btn btn-icon bg-gradient-secondary float-right reset_form" >
          Add
        </a> 
    </h5>
  </div>
          ...
          <table id="my_data_table" class="table table-bordered table-striped table-actions" >
              <thead>
                  <tr>
                      ...
                      <th width="15%">Mocktest Name</th>
                      <th width="15%">Image</th>
                      <th width="5%">Total Time</th>                      
                      <th width="10%" class="text-center">Assign<br> Q</th>
              ...
              success: function(response){   
                  if(response.result.length>0){ 
                      ...
                      if(typeof is_modal === 'object'  || is_modal === '0' || is_modal === 'null' || is_modal == 0)
                    {
                      ...
                      var selectedOptions = categories.split(',');
          ...
          if($('#my_data_table').length > 0){
              $('#my_data_table').DataTable({
                  ...
                  columns:[
                      ...
                      {data:"mocktest_name",name:"mocktest_name"},
                      ...
                      {data:"assign_question",name:"assign_question"},
