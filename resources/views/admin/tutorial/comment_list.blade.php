                  ...
                  <table id="my_data_table" class="table table-bordered table-striped table-actions" >
                      ...
                      <tbody>  
                          ...
                          <?php 
                            ...
                            $adminComment=App\Models\VideoComment::where("parent_id",$val->id)->first();
                          ?>
                          <tr>
                              <td>{{$val->user->name}}</td>
                              <td>{{$val->comment}}</td>
                              ...
                              <td><a href="{{url('/replyCommentTutorial')}}/{{$val->id}}" >Reply To Comment</a></td>
                              <td>
                                  <a href="{{url('/deleteCommentTutorial')}}/{{$val->id}}" class="btn bg-gradient-danger btn-rounded btn-condensed btn-sm s_btn1 view_in_modal">X</a>
                                  <a href="{{url('/editCommentTutorial')}}/{{$val->id}}" class="btn bg-gradient-secondary btn-rounded
