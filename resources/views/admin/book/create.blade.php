...
<div class="card">
  ...
  <div class="card-body">
    <form id="validate" action="/book" class="form-horizontal comm_form" method="POST" role="form" enctype="multipart/form-data">
      @csrf
      ...
      <div class="row fil_ters ">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control "  id="addon" placeholder=" Book Addon" name="addon[]" autocomplete="off">
